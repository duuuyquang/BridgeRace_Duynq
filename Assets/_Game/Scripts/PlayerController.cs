...
{
    private const float START_MOVING_DISTANCE_UNIT = 15f;
    ...
    public void SetCurDirection()
    {
        ...
        if (Input.GetMouseButton(0))
        {
            ...
            //if (Vector3.Distance(mouseStartPoint, mouseEndPoint) >= 300f)
            //{
            //    Vector3 track = mouseEndPoint;
            //    mouseStartPoint = track;
            //    Debug.Log("Track");
            //}
        }
    }
